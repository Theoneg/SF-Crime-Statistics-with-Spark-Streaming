...
def udf_convert_time(timestamp):
    ...
    return str(date_time.strftime('%y%y%d%H'))
...
def run_spark_job(spark):
    ...
    counts_df = distinct_table\
        ...
        .groupBy(psf.window(distinct_table.call_datetime,
                            "10 minutes", 
                            "10 minutes"),
